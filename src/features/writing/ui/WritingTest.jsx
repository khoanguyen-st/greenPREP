  ...
  return (
    <div className="max-w-3xl mx-auto p-5">
      ...
      <QuestionNavigator
        ...
        />
      <Title level={1} className="text-left text-[40px] font-[700]">
        Writing Test 
      </Title>
      <Text className="mb-5 text-[35px] font-[600]"> Question {currentPartIndex + 1} of {data.Parts.length}</Text>
      ...
      <Form form={form} layout="vertical">
        {currentPart.Questions.map((question, index) => {
          ...
          const maxWords = partNumber === 1 ? null : question.maxWords || DEFAULT_MAX_WORDS[partNumber] || 50;
                ...
                {maxWords && (
                  <Text
                    className={`block text-sm mt-1 ${
                      wordCounts[fieldName] > maxWords ? "text-red-500" : "text-gray-500"
                    }`}
                  >
