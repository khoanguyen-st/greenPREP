...
const { Option } = Select
import OrderingQuestion from '@shared/ui/questionType/OrderingQuestion'
...
import QuestionNavigatorContainer from './reading-question-navigator'
import FooterNavigator from './reading-footer-navigator'
