...
/**
 * Utility function to retrieve and validate global data from localStorage
 * @returns {Object|null} The global data object or null if validation fails
 */
...
/**
 * Custom hook to retrieve and validate global data from localStorage
 * @returns {Object} An object containing the global data and error handling functions
 */
export const useGlobalData = () => {
  ...
  /**
   * Retrieves and validates global data from localStorage
   * @returns {Object|null} The global data object or null if validation fails
   */
  const getGlobalData = () => {
    try {
